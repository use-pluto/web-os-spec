function register() {
  ...
  content.innerHTML = `Tried to register protocol handler, visit a link such as <a target="_blank" href="web+os:directory/file.txt">this one</a> to see if it was successful`;
  let url = new URL(location.href)
  let theStuff = url.searchParams.get("protocol")
  if (theStuff) {
